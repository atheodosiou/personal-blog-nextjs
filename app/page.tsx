      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:mt-5 lg:py-20">
        <div className="container flex flex-col gap-10 text-center">
          ...
          <p className="max-w-[42rem] mx-auto text-muted-foreground sm:text-xl text-balance">
            Hi there! 😊 I’m a Senior Frontend Engineer with a passion for
            Angular and building seamless web experiences. Welcome to my corner
            of the internet! Explore my work, ideas, and journey in crafting
            modern, user-centric applications. I’m thrilled to have you here! 🚀
          </p>
